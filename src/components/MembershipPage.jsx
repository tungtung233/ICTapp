  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.collaboratory}>
        ...
        <Text style={styles.collabParagraph}>Once you are a member, you can enroll in the Collaboratory - our 12 week flagship program broken up into 3 sprints:</Text>
        <Text style={styles.collabList}>{`Sprint 1: Foundations\nSprint 2: Alignment\nSprint 3: Building your Team`}</Text>
        <Text style={styles.collabParagraph}>A new cohort starts every three months. Click here to find out more information about the course syllabus and fees, and to register for an information session.</Text>
      </View>
